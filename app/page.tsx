    ...
    <main className={`${oswald.className} min-h-screen text-[#ffffff] selection:bg-[#68121f] selection:text-white overflow-x-hidden relative`}>
      ...
      <section className="relative min-h-screen w-full overflow-hidden flex flex-col pt-[54px] z-10">
        ...
        <div className="relative z-10 flex-grow flex flex-col items-center justify-center text-center px-[15px] py-12 md:py-20 mt-[-40px] md:mt-[-80px]">
          ...
          {/* GRID DE BENEFÍCIOS - RESTAURADO PARA 4 BOXES */}
          <div className="mt-12 md:mt-16 grid grid-cols-1 md:grid-cols-2 gap-[20px] md:gap-[30px] w-full max-w-[900px] mx-auto">
            <div className="bg-black/60 backdrop-blur-md p-6 md:p-8 border-l-4 border-[#68121f] text-left">
            ...
            <div className="bg-black/60 backdrop-blur-md p-6 md:p-8 border-l-4 border-[#68121f] text-left">
              <div className="mb-4 text-white">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75m0 3v.75m0 3v.75m0 3V15m19.125-11.25h-15c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h15c.621 0 1.125-.504 1.125-1.125V5.625c0-.621-.504-1.125-1.125-1.125Z" />
                </svg>
              </div>
            ...
            <div className="bg-black/60 backdrop-blur-md p-6 md:p-8 border-l-4 border-[#68121f] text-left">
              ...
              <p className="text-xs font-bold uppercase tracking-wider leading-snug">Gestão simples e rápida pelo portal do sócio</p>
            </div>
          </div>
