...
export default function Home() {
  ...
  // Estilos tipográficos ajustados para melhor legibilidade e fluidez
  const titleStyle = {
    ...
    <main className={`${oswald.variable} font-sans min-h-screen text-[rgb(248,248,248)] selection:bg-[#451021] selection:text-white overflow-x-hidden relative font-normal`} style={{ fontStyle: 'normal', fontFamily: 'var(--font-oswald)' }}>
      ...
      <section className="relative min-h-screen w-full overflow-hidden flex flex-col pt-[54px] z-10">
        ...
        <div className="relative z-20 w-full px-2 md:px-6 py-4 flex justify-between items-start">
          ...
          <div className="flex items-center gap-3 md:gap-6 pt-2 pr-2 md:pr-6">
            ...
            <a href={REDIRECT_URL} className={`${buttonFontStyle} bg-[#451021] text-[rgb(248,248,248)] px-4 md:px-8 py-2 md:py-3 rounded-sm text-[14px] md:text-lg uppercase hover:bg-[#185347] transition-all shadow-lg inline-block tracking-widest`}>
              Cadastre-se
            </a>
          </div>
        </div>
        ...
        <div className="relative z-10 flex-grow flex flex-col items-center justify-center text-center px-[15px] py-12 md:py-20 mt-[-60px] md:mt-[-100px]">
          ...
          <div className="mt-12 md:mt-16 grid grid-cols-4 gap-[10px] md:gap-[15px] w-full max-w-[1200px] mx-auto">
            <div className="bg-black/60 backdrop-blur-md p-3 md:p-5 border-l-4 border-[#451021] text-left">
              ...
              <p className="text-[8px] md:text-xs font-bold uppercase tracking-[0.15em] leading-relaxed text-[rgb(248,248,248)]">Mais prioridade na compra de ingressos</p>
            </div>
            <div className="bg-black/60 backdrop-blur-md p-3 md:p-5 border-l-4 border-[#451021] text-left">
              <div className="mb-4 text-[rgb(248,248,248)] hidden md:block">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
              ...
              <p className="text-[8px] md:text-xs font-bold uppercase tracking-[0.15em] leading-relaxed text-[rgb(248,248,248)]">Viva o jogo com quem faz parte da sua história</p>
            </div>
            <div className="bg-black/60 backdrop-blur-md p-3 md:p-5 border-l-4 border-[#451021] text-left">
              <div className="mb-4 text-[rgb(248,248,248)] hidden md:block">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
              ...
              <p className="text-[8px] md:text-xs font-bold uppercase tracking-[0.15em] leading-relaxed text-[rgb(248,248,248)]">Desconto garantido para todos os convidados</p>
            </div>
            <div className="bg-black/60 backdrop-blur-md p-3 md:p-5 border-l-4 border-[#451021] text-left">
              <div className="mb-4 text-[rgb(248,248,248)] hidden md:block">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
              ...
              <p className="text-[8px] md:text-xs font-bold uppercase tracking-[0.15em] leading-relaxed text-[rgb(248,248,248)]">Vamos todos juntos rumo à glória</p>
            </div>
          </div>

          <div className="mt-12 md:mt-16 flex justify-center">
            <a href={REDIRECT_URL} className={`${buttonFontStyle} bg-[#451021] text-[rgb(248,248,248)] px-10 md:px-14 py-4 md:py-5 rounded-sm text-xl md:text-2xl uppercase hover:bg-[#185347] transition-all shadow-[0_0_40px_rgba(69,16,33,0.4)] hover:scale-105 block w-fit tracking-[0.15em]`}>
            ...
            <div className="flex flex-col space-y-5">
              ...
              <div className="space-y-6 text-[rgb(248,248,248)]">
                ...
                <div className="bg-black/20 border-l-4 border-[#451021] p-6 space-y-2">
                  ...
                  <p className="text-xs text-[rgb(248,248,248)] opacity-60 font-medium italic tracking-[0.1em]">
      ...
      <section className="py-20 md:py-32 relative z-10 bg-black/40">
        <div className="max-w-[1140px] mx-auto px-[15px]">
            ...
            <div className="bg-black/70 border-t-8 border-[#451021] rounded-b-xl shadow-2xl flex flex-col md:flex-row overflow-hidden">
              <div className="flex-1 p-8 md:p-10">
                <div className="flex flex-col sm:flex-row justify-between items-start mb-8 gap-4">
                  ...
                  <span className="font-bold bg-[#451021] text-[rgb(248,248,248)] text-sm px-4 py-1.5 rounded whitespace-nowrap inline-block tracking-[0.2em]" style={{ fontStyle: 'normal', fontFamily: 'var(--font-oswald)' }}>MAIS COMPLETO</span>
                </div>
                <ul className="space-y-5 mb-10">
                  <li className="flex items-start gap-3 text-[rgb(248,248,248)] font-normal text-sm tracking-[0.08em] leading-relaxed">
                  ...
                  <li className="flex items-start gap-3 text-[rgb(248,248,248)] font-bold text-sm tracking-[0.08em] leading-relaxed">
                    <div className="h-2 w-2 bg-[#451021] rounded-full mt-1.5 shrink-0"></div>
                    Mais pessoas com prioridade nos ingressos
                  </li>
                </ul>
                <p className="text-[10px] md:text-xs text-[rgb(248,248,248)] opacity-50 italic font-normal tracking-[0.1em]">*Valor por convidado: R$ 25,00/mês</p>
              </div>
          ...
          <div className="relative w-full h-[400px] md:h-[550px] rounded-2xl overflow-hidden mb-20 md:mb-32 shadow-2xl">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6 md:p-16">
              <h3 
                ...
                style={{...sectionTitleStyle, fontSize: 'clamp(28px, 3.5vw, 56px)', lineHeight: '1.3', letterSpacing: '0.05em'}}
              >
                A Libertadores está chegando. Quem vai estar ao seu lado quando o Maraca pulsar com o verde, branco e grená?
              </h3>
              <h3 className="font-bold md:hidden text-3xl uppercase tracking-normal mb-8 max-w-4xl drop-shadow-2xl leading-[1.2] text-[rgb(248,248,248)]" style={{ fontStyle: 'normal', fontFamily: 'var(--font-oswald)' }}>
                A Libertadores está chegando. Quem vai estar ao seu lado quando o Maraca pulsar com o verde, branco e grená?
              </h3>
          ...
          <div className="flex flex-col items-center pb-12 md:pb-20">
            <a href={REDIRECT_URL} className={`${buttonFontStyle} bg-[#185347] text-[rgb(248,248,248)] px-10 md:px-14 py-5 md:py-7 rounded-sm text-xl md:text-3xl uppercase hover:bg-[#451021] transition-all shadow-2xl hover:scale-105 mb-6 inline-block tracking-[0.2em]`}>
              Quero trazer meu convidado
            </a>
            <p className="text-[rgb(248,248,248)] opacity-80 font-bold uppercase tracking-[0.3em] text-[10px] md:text-xs drop-shadow-md">Leva menos de 1 minuto.</p>
          </div>
        </div>
      </section>
      ...
      <footer className="py-12 md:py-16 border-t border-white/10 bg-[#185347] backdrop-blur-md relative z-10">
        <div className="max-w-[1140px] mx-auto px-[15px] text-center">
          ...
          <p className="text-[rgb(248,248,248)] opacity-40 text-[8px] md:text-[9px] uppercase tracking-[0.3em] font-bold">
