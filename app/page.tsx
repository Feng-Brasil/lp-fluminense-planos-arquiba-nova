...
export default function Home() {
  ...
  // Estilos tipográficos baseados no link de referência (nense.com.br/planos/arquiba)
  // Ajustes de letter-spacing (rastreamento) e line-height (entrelinha)
  const titleStyle = {
  ...
  const buttonFontStyle = `font-bold tracking-[0.05em]`;
    ...
    <main className={`${oswald.variable} font-sans min-h-screen text-[rgb(248,248,248)] selection:bg-[#451021] selection:text-white overflow-x-hidden relative font-normal`} style={{ fontStyle: 'normal', fontFamily: 'var(--font-oswald)' }}>
      ...
      <section className="relative min-h-screen w-full overflow-hidden flex flex-col pt-[54px] z-10">
        ...
        <div className="relative z-20 w-full px-2 md:px-6 py-4 flex justify-between items-start">
          ...
          <div className="flex items-center gap-3 md:gap-6 pt-2 pr-2 md:pr-6">
            <a href={REDIRECT_URL} className={`flex items-center gap-2 cursor-pointer hover:opacity-80 transition-opacity ${buttonFontStyle} text-[rgb(248,248,248)]`}>
              ...
              <span className="text-[14px] md:text-lg uppercase">Login</span>
            </a>
            <a href={REDIRECT_URL} className={`${buttonFontStyle} bg-[#451021] text-[rgb(248,248,248)] px-4 md:px-8 py-2 md:py-3 rounded-sm text-[14px] md:text-lg uppercase hover:bg-[#185347] transition-all shadow-lg inline-block`}>
              Cadastre-se
            </a>
          </div>
        </div>
        ...
        <div className="relative z-10 flex-grow flex flex-col items-center justify-center text-center px-[15px] py-12 md:py-20 mt-[-60px] md:mt-[-100px]">
          ...
          <div className="space-y-12 md:space-y-16">
            ...
            <h1 className="font-bold md:hidden text-6xl leading-[0.9] tracking-tighter text-[rgb(244,244,244)] drop-shadow-2xl uppercase" style={{ fontStyle: 'normal', fontFamily: 'var(--font-oswald)' }}>
              O FLU SE VIVE JUNTO!
            </h1>
            
            <p className="text-base md:text-xl lg:text-2xl font-bold max-w-[800px] mx-auto text-[rgb(248,248,248)] drop-shadow-lg leading-relaxed tracking-wide">
          ...
          <div className="mt-12 md:mt-16 grid grid-cols-4 gap-[10px] md:gap-[15px] w-full max-w-[1200px] mx-auto">
            <div className="bg-black/60 backdrop-blur-md p-3 md:p-5 border-l-4 border-[#451021] text-left">
              ...
              <p className="text-[8px] md:text-xs font-bold uppercase tracking-widest leading-snug text-[rgb(248,248,248)]">Mais prioridade na compra de ingressos</p>
            </div>
            <div className="bg-black/60 backdrop-blur-md p-3 md:p-5 border-l-4 border-[#451021] text-left">
              <div className="mb-4 text-[rgb(248,248,248)] hidden md:block">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
              ...
              <p className="text-[8px] md:text-xs font-bold uppercase tracking-widest leading-snug text-[rgb(248,248,248)]">Viva o jogo com quem faz parte da sua história</p>
            </div>
            <div className="bg-black/60 backdrop-blur-md p-3 md:p-5 border-l-4 border-[#451021] text-left">
              <div className="mb-4 text-[rgb(248,248,248)] hidden md:block">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
              ...
              <p className="text-[8px] md:text-xs font-bold uppercase tracking-widest leading-snug text-[rgb(248,248,248)]">Desconto garantido para todos os convidados</p>
            </div>
            <div className="bg-black/60 backdrop-blur-md p-3 md:p-5 border-l-4 border-[#451021] text-left">
              <div className="mb-4 text-[rgb(248,248,248)] hidden md:block">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
              ...
              <p className="text-[8px] md:text-xs font-bold uppercase tracking-widest leading-snug text-[rgb(248,248,248)]">Vamos todos juntos rumo à glória</p>
            </div>
          </div>

          <div className="mt-12 md:mt-16 flex justify-center">
            <a href={REDIRECT_URL} className={`${buttonFontStyle} bg-[#451021] text-[rgb(248,248,248)] px-10 md:px-14 py-4 md:py-5 rounded-sm text-xl md:text-2xl uppercase hover:bg-[#185347] transition-all shadow-[0_0_40px_rgba(69,16,33,0.4)] hover:scale-105 block w-fit`}>
      ...
      <section className="relative min-h-[80vh] md:min-h-[90vh] w-full flex items-center justify-center z-10 bg-[#185347] backdrop-blur-xl py-12 md:py-20 border-y border-white/5">
        <div className="max-w-[1140px] mx-auto px-[15px] w-full">
          <div className="mb-8 md:mb-10">
            <h2 className="font-bold text-[rgb(248,248,248)] tracking-[0.15em] text-lg md:text-xl uppercase" style={{ fontStyle: 'normal', fontFamily: 'var(--font-oswald)' }}>Como funciona o convidado:</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
            <div className="flex flex-col space-y-5">
              ...
              <h3 className="font-bold md:hidden text-4xl uppercase tracking-tighter leading-[0.95] text-[rgb(248,248,248)]" style={{ fontStyle: 'normal', fontFamily: 'var(--font-oswald)' }}>
                Leve até 3 pessoas para todos os jogos
              </h3>
              <div className="space-y-5 text-[rgb(248,248,248)]">
                <p className="text-base md:text-lg font-bold text-[rgb(248,248,248)] leading-relaxed tracking-wide">
                ...
                <div className="space-y-2">
                  <h4 className="font-bold text-[rgb(248,248,248)] uppercase tracking-[0.1em] text-xl" style={{ fontStyle: 'normal', fontFamily: 'var(--font-oswald)' }}>Como usar na prática:</h4>
                  <p className="text-sm md:text-base leading-relaxed text-[rgb(248,248,248)] opacity-80 tracking-wide">
                ...
                <div className="bg-black/20 border-l-4 border-[#451021] p-5 space-y-1">
                  <p className="font-bold text-2xl md:text-3xl text-[rgb(248,248,248)] tracking-tight" style={{ fontStyle: 'normal', fontFamily: 'var(--font-oswald)' }}>
                    R$ 25 por mês por convidado contratado
                  </p>
                  <p className="text-xs text-[rgb(248,248,248)] opacity-60 font-medium italic tracking-wide">
                    Simples, acessível e pensado para você nunca precisar ir sozinho ao Maracanã.
                  </p>
                </div>
              </div>
              <div className="pt-4">
                <a href={REDIRECT_URL} className={`${buttonFontStyle} bg-transparent border-2 border-[#451021] text-[rgb(248,248,248)] px-10 py-4 rounded-sm text-lg uppercase hover:bg-[#451021] transition-all shadow-lg inline-block`}>
            ...
            <div className="relative group md:-mr-12 lg:-mr-20">
              ...
              <div className="relative rounded-sm overflow-hidden shadow-2xl border border-white/10 aspect-[16/10] md:aspect-[4/5] lg:aspect-square max-h-[650px] w-full">
                ...
                <div className="absolute bottom-8 left-8 right-8">
                  <p className="font-bold text-lg uppercase tracking-[0.15em] text-[rgb(248,248,248)] opacity-90" style={{ fontStyle: 'normal', fontFamily: 'var(--font-oswald)' }}>A experiência completa de ser tricolor</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 md:py-32 relative z-10 bg-black/40">
        <div className="max-w-[1140px] mx-auto px-[15px]">
          <div className="text-center mb-16 md:mb-24 flex flex-col items-center">
            ...
            <p className="text-base md:text-xl text-[rgb(248,248,248)] max-w-3xl mx-auto drop-shadow-md font-normal leading-relaxed tracking-wide">
            ...
            <div className="bg-black/70 border-t-8 border-[#451021] rounded-b-xl shadow-2xl flex flex-col md:flex-row overflow-hidden">
              <div className="flex-1 p-8 md:p-10">
                <div className="flex flex-col sm:flex-row justify-between items-start mb-8 gap-4">
                  <h3 className="font-bold text-3xl md:text-4xl tracking-tight text-[rgb(248,248,248)]" style={{ fontStyle: 'normal', fontFamily: 'var(--font-oswald)' }}>ARQUIBA 100%</h3>
                  <span className="font-bold bg-[#451021] text-[rgb(248,248,248)] text-sm px-4 py-1.5 rounded whitespace-nowrap inline-block tracking-[0.1em]" style={{ fontStyle: 'normal', fontFamily: 'var(--font-oswald)' }}>MAIS COMPLETO</span>
                </div>
                <ul className="space-y-4 mb-10">
                  <li className="flex items-start gap-3 text-[rgb(248,248,248)] font-normal text-sm tracking-wide">
                  ...
                  <li className="flex items-start gap-3 text-[rgb(248,248,248)] font-bold text-sm tracking-wide">
                    <div className="h-2 w-2 bg-[#451021] rounded-full mt-1.5 shrink-0"></div>
                    Mais pessoas com prioridade nos ingressos
                  </li>
                </ul>
                <p className="text-[10px] md:text-xs text-[rgb(248,248,248)] opacity-50 italic font-normal tracking-wide">*Valor por convidado: R$ 25,00/mês</p>
              </div>
            ...
            <div className="bg-black/70 border-t-8 border-[#185347] rounded-b-xl shadow-2xl flex flex-col md:flex-row overflow-hidden">
              <div className="flex-1 p-8 md:p-10">
                <div className="flex justify-between items-start mb-8">
                  <h3 className="font-bold text-3xl md:text-4xl tracking-tight text-[rgb(248,248,248)]" style={{ fontStyle: 'normal', fontFamily: 'var(--font-oswald)' }}>ARQUIBA 75%</h3>
                </div>
                <ul className="space-y-4 mb-10">
                  <li className="flex items-start gap-3 text-[rgb(248,248,248)] font-normal text-sm tracking-wide">
          ...
          <div className="relative w-full h-[400px] md:h-[550px] rounded-2xl overflow-hidden mb-20 md:mb-32 shadow-2xl">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6 md:p-16">
              <h3 
                className="hidden md:block uppercase mb-12 max-w-5xl drop-shadow-2xl"
                style={{...sectionTitleStyle, fontSize: 'clamp(28px, 3.5vw, 56px)', lineHeight: '1.1', letterSpacing: '-0.01em'}}
              >
                A Libertadores está chegando. Quem vai estar ao seu lado quando o Maraca pulsar com o verde, branco e grená?
              </h3>
              <h3 className="font-bold md:hidden text-3xl uppercase tracking-tighter mb-8 max-w-4xl drop-shadow-2xl leading-[0.95] text-[rgb(248,248,248)]" style={{ fontStyle: 'normal', fontFamily: 'var(--font-oswald)' }}>
                A Libertadores está chegando. Quem vai estar ao seu lado quando o Maraca pulsar com o verde, branco e grená?
              </h3>
              <a href={REDIRECT_URL} className={`${buttonFontStyle} bg-[#451021] text-[rgb(248,248,248)] px-6 md:px-10 py-4 md:py-6 rounded-sm shadow-xl border border-white/10 inline-block`}>
                <p className="text-xl md:text-3xl uppercase tracking-[0.1em]">contrate um convidado!</p>
              </a>
            </div>
          </div>

          <div className="flex flex-col items-center pb-12 md:pb-20">
            <a href={REDIRECT_URL} className={`${buttonFontStyle} bg-[#185347] text-[rgb(248,248,248)] px-10 md:px-14 py-5 md:py-7 rounded-sm text-xl md:text-3xl uppercase hover:bg-[#451021] transition-all shadow-2xl hover:scale-105 mb-6 inline-block`}>
      ...
      <footer className="py-12 md:py-16 border-t border-white/10 bg-[#185347] backdrop-blur-md relative z-10">
        <div className="max-w-[1140px] mx-auto px-[15px] text-center">
          <p className="font-bold uppercase tracking-[0.15em] text-lg md:text-xl mb-4 text-[rgb(248,248,248)]" style={{ fontStyle: 'normal', fontFamily: 'var(--font-oswald)' }}>
